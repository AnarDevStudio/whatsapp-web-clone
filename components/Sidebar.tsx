      ...
      <div className="flex h-full flex-col justify-between items-center">
        <div className="flex flex-col items-center">
          ...
          <img
            ...
            alt="Meta AI"
            className="flex items-center justify-center hover:text-white hover:bg-[#343636] hover:rounded-full p-2 transition-all"
            width={40}
          />
        </div>
        <div className="flex flex-col justify-center items-center space-y-3">
          <div className="text-[#a5a5a5] p-2">
            <svg
              viewBox="0 0 24 24"
              height="19"
              width="19"
