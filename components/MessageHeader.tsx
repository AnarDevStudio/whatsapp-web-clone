export default function MessageHeader({ name }: { name: string }) {
  return (
    <div className="flex justify-between items-center w-full h-15 bg-[#161717]">
      <div className="flex items-center p-2 ml-2">
        <div className="h-9 w-9 bg-blue-600 rounded-full" />
        <div className="text-white ml-3 font-bold">{name}</div>
      </div>
      <div className="flex text-white space-x-6 mr-5">
        <svg
          viewBox="0 0 24 24"
          height="24"
          width="24"
